...
public class ContactManagement {
	...
	public ContactManagement() {
		...
		mContactList.add(new Contact("1000", "KimThinh", "잘가요 안녕 내사랑 ", "mnt/sdcard/download/icon_1000.png"));
		mContactList.add(new Contact("1001", "YoungHwa", "날 찾아오신 내님 어서 오세요", "mnt/sdcard/download/icon_1001.png"));
		mContactList.add(new Contact("1002", "TuanHao", EMPTY, "mnt/sdcard/download/icon_1002.png"));
		mContactList.add(new Contact("1003", "JaeKyung", EMPTY, "mnt/sdcard/download/icon_1003.png"));
		mContactList.add(new Contact("1004", "JiWon", "어서 오세요 당신의 꽃이 될래요", "mnt/sdcard/download/icon_1004.png"));
		mContactList.add(new Contact("1005", "NgocThanh", EMPTY, "mnt/sdcard/download/icon_1005.png"));
