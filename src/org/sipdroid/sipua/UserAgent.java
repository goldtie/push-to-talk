...
public class UserAgent extends CallListenerAdapter {
	...
	/** Audio application */
	public static MediaLauncher audio_app = null;
...
//			addMediaDescriptor("audio", user_profile.audio_port, c, user_profile.audio_sample_rate);
	...
	private void addMediaDescriptor(String media, int port, int avp,
		...
		// HAO SUA TAM
		// CON THIEU CODEC doa !!
		StringBuilder str = new StringBuilder(sdp.toString());
		str.replace(str.indexOf("RTP/AVP 103"), str.indexOf("RTP/AVP 103")+11, "RTP/AVP 103 26 34\na=rtpmap:26 JPEG/0\na=rtpmap:34 H263/0");
		
		local_session = str.toString();
...
//	private void addMediaDescriptor(String media, int port, Codecs.Map c,int rate) {
	...
	protected void launchMediaApplication() {
		...
		if (user_profile.audio && local_audio_port != 0
			...
			// Here start the MBCP for PTT -->
			if (Presence.mIsPttService){
				//android.util.Log.d("HAO", "Sipdroid.audio_mbcp_process.HelloMSG(user_profile.username)");
				//Sipdroid.audio_mbcp_process.HelloMSG(user_profile.username);
				audio_app.startReceiveMedia();
				
				//Sipdroid.video_mbcp_process.HelloMSG(user_profile.username);
			}
			else
...
//		changeStatus(UA_STATE_INCALL); modified
	...
	public void onCallRefused(Call call, String reason, Message resp) {
		android.util.Log.d("HAO", "onCallRefused");
	...
	public void onCallCanceling(Call call, Message cancel) {
		android.util.Log.d("HAO", "onCallCanceling");
	...
	public void onCallClosing(Call call, Message bye) {
		android.util.Log.d("HAO", "onCallClosing");
	...
	public void onCallClosed(Call call, Message resp) {
		android.util.Log.d("HAO", "onCallClosed");
	...
	public void onCallTimeout(Call call) {
		android.util.Log.d("HAO", "onCallTimeout");
	...
	private void runAutomaticHangup(int delay_time) {
		...
		android.util.Log.d("HAO", "UA_runAutomaticHangup()=> HANGUP");
		if (call != null && call.isOnCall()) {
