...
public class VideoCamera extends CallScreen implements SipdroidListener,
	...
	public void onCreate(Bundle icicle) {
		Log.d("HAO", "VideoCamera_OnCreate");
	...
	public void onResume() {
		Log.d("HAO", "VideoCamera_onResume");
		if (!Sipdroid.release)
		...
		if (!justplay) {
			...
			mVideoFrame.setVideoURI(Uri.parse("rtsp://video2.multicasttech.com/AFTVHorror3GPP296.sdp"));
			// mVideoFrame.setVideoURI(Uri.parse("rtsp://220.149.84.75:8080/test.sdp"));
			// mVideoFrame.setVideoPath("rtsp://220.149.84.75:8080/test.sdp");
			mVideoFrame
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Log.d("HAO", "VideoCamera_onKeyDown");
		switch (keyCode) {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		Log.d("HAO", "VideoCamera_onPrepareOptionsMenu");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		Log.d("HAO", "VideoCamera_onOptionsItemSelected");
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
		Log.d("HAO", "VideoCamera_surfaceChanged");
		if (!justplay && !mMediaRecorderRecording)
			initializeVideo();
	}

	public void surfaceCreated(SurfaceHolder holder) {
		Log.d("HAO", "VideoCamera_surfaceCreated");
		mSurfaceHolder = holder;
	}

	public void surfaceDestroyed(SurfaceHolder holder) {
		Log.d("HAO", "VideoCamera_surfaceDestroyed");
		mSurfaceHolder = null;
	}
	...
	private void checkForCamera() {
		Log.d("HAO", "VideoCamera_checkForCamera");
		try {
	...
	private boolean initializeVideo() {
		Log.d("HAO", "VideoCamera_initializeVideo");
	...
	private void releaseMediaRecorder() {
		Log.d("HAO", "VideoCamera_releaseMediaRecorder");
	...
	private void startVideoRecording() {
		Log.d("HAO", "VideoCamera_startVideoRecording");
	...
	private void stopVideoRecording() {
		Log.d("HAO", "VideoCamera_stopVideoRecording");
	...
	private void setScreenOnFlag() {
		Log.d("HAO", "VideoCamera_setScreenOnFlag");
	...
	public void onHangup() {
		Log.d("HAO", "VideoCamera_onHangup");
	...
	public boolean onLongClick(View v) {
		Log.d("HAO", "VideoCamera_onLongClick");
