...
public class InCallScreen extends CallScreen implements View.OnClickListener, SensorEventListener {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Log.d("HAO", "InCallScreen_onKeyDown");
        switch (keyCode) {
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		Log.d("HAO", "InCallScreen_onKeyUp");
		switch (keyCode) {
        case KeyEvent.KEYCODE_VOLUME_DOWN:
        case KeyEvent.KEYCODE_VOLUME_UP:
	...
	public void onAccuracyChanged(Sensor sensor, int accuracy) {
		Log.d("HAO", "InCallScreen_onAccuracyChanged");
	}
	...
	public void onSensorChanged(SensorEvent event) {
		Log.d("HAO", "InCallScreen_onSensorChanged");
		if (first) {
			first = false;
			return;
		}
